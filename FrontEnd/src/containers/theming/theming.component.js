      ...
      <Grid container spacing={0}>
        ...
        <Grid item xs={10} >
          <Paper className={scss['portal-pages__content-inner']}>
            <Typography variant="h6" gutterBottom>Theming</Typography>
            ...
            >
              <Grid item xs={6}>
                <Typography variant="subtitle2" gutterBottom>Side Navigation Colors</Typography>
                <Grid
                  container
                  direction="row"
                  justify="space-between"
              ...
              <Grid item xs={6}>
                <Typography variant="subtitle2" gutterBottom>Main Content Colors</Typography>
                <Grid
                  container
                  direction="row"
                  justify="space-between"
