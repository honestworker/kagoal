        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              <TableCell numeric="true">Page Views</TableCell>
              <TableCell numeric="true">Duration</TableCell>
              <TableCell numeric="true">Conversion Rate</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {data.slice(page * rowsPerPage, (page * rowsPerPage) + rowsPerPage).map(n => (
              <TableRow key={n.url}>
                ...
                <TableCell numeric="true">{n.views}</TableCell>
                <TableCell numeric="true">{n.duration}</TableCell>
                <TableCell numeric="true">{n.conversion}</TableCell>
              </TableRow>))
            }
          </TableBody>
          <TableFooter>
