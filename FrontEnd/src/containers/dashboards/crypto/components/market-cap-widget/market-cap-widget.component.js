          ...
          <Table>
            <TableHead>
              <TableRow>
                ...
                <TableCell className={classes['table-cell']} numeric="true">Market Cap</TableCell>
                <TableCell className={classes['table-cell']} numeric="true">Price</TableCell>
                <TableCell className={classes['table-cell']} numeric="true">Supply</TableCell>
                <TableCell className={classes['table-cell']} numeric="true">Change</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {data.map(item => (
                <TableRow key={item.index}>
                  ...
                  <TableCell className={classes['table-cell']} numeric="true">{item.price}</TableCell>
                  <TableCell className={classes['table-cell']} numeric="true">{item.supply}</TableCell>
                  <TableCell className={classes['table-cell']} numeric="true">{item.change}</TableCell>
                </TableRow>))
              }
            </TableBody>
          </Table>
