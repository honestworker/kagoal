          ...
          <Table>
            <TableHead>
              <TableRow>
                ...
                <TableCell className={classes['table-cell']} numeric="true">Estimated time</TableCell>
                <TableCell className={classes['table-cell']} numeric="true">Status</TableCell>
                <TableCell className={classes['table-cell']} numeric="true">Priority</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {data.map(item => {
                ...
                return (
                  <TableRow
                    ...
                    <TableCell className={classes['table-cell']} numeric="true">{item.time}</TableCell>
                    <TableCell className={classes['table-cell']} numeric="true">{item.status}</TableCell>
                    <TableCell className={classes['table-cell']} numeric="true">{item.priority}</TableCell>
                  </TableRow>);
                })}
            </TableBody>
          </Table>
